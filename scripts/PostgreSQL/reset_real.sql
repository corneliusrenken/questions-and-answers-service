...
COPY questions
FROM '/Users/home/Hack Reactor/Immersive/SDC/QuestionsAndAnswersService/data/real/questions.csv'
DELIMITER ','
CSV HEADER;

COPY answers
FROM '/Users/home/Hack Reactor/Immersive/SDC/QuestionsAndAnswersService/data/real/answers.csv'
DELIMITER ','
CSV HEADER;

COPY answers_photos
FROM '/Users/home/Hack Reactor/Immersive/SDC/QuestionsAndAnswersService/data/real/answers_photos.csv'
DELIMITER ','
CSV HEADER;
